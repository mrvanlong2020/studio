          ...
          <div className="space-y-0.5">
            {mainNavItems.map((item) => {
              ...
              return (
                ...
                >
                  <item.icon className={cn("w-4.5 h-4.5 transition-transform duration-200 group-hover:scale-110", isActive ? "text-sidebar-accent-foreground" : "text-muted-foreground")} />
                  {item.label}
                </Link>
              );
            })}
